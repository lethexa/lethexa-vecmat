...
describe('Box3d', function () {
    ...
    describe('#box3dFromElements()', function () {
        it('should return an initialized box', function () {
            var box = vecmat.box3dFromElements(0, 0, 0, 10, 10, 10);

            assert.deepEqual(box.toArray(), [0, 0, 0, 10, 10, 10]);
        });
    });

    describe('#box3dFromArray()', function () {
        it('should return an initialized box', function () {
            var box = vecmat.box3dFromArray([0, 0, 0, 10, 10, 10]);
    ...
    describe('#toArray()', function () {
        it('should return an initialized box', function () {
            var box = new vecmat.Box3d(new vecmat.Vector3d(0.0, 0.0, 0.0), new vecmat.Vector3d(10.0, 10.0, 10.0));
...
describe('Sector2d', function () {
    ...
    describe('#containsPoint()', function () {
        it('should return true if point is contained', function () {
            var s = new vecmat.Sector2d(new vecmat.Vector2d(0.0, 0.0), Math.PI/2.0, 0);
            var p = new vecmat.Vector2d(-1.0, 1.0);
...
describe('Sector3d', function () {

    describe('#isEqualTo()', function () {
        it('should return true if both are equal', function () {
            var p1 = new vecmat.Sector3d(new vecmat.Vector3d(0.0, 0.0, 0.0), 0, Math.PI, -Math.PI/2, Math.PI/2);
            var p2 = new vecmat.Sector3d(new vecmat.Vector3d(0.0, 0.0, 0.0), 0, Math.PI, -Math.PI/2, Math.PI/2);
    ...
    describe('#isEqualTo()', function () {
        it('should return false if both are NOT equal', function () {
            var p1 = new vecmat.Sector3d(new vecmat.Vector3d(0.0, 0.0, 0.0), 0, 2*Math.PI, -Math.PI/2, Math.PI/2);
            var p2 = new vecmat.Sector3d(new vecmat.Vector3d(0.0, 0.0, 0.0), 0, Math.PI, -Math.PI/2, Math.PI/2);
    ...
    describe('#containsPoint()', function () {
        it('should return true if point is contained', function () {
            var s = new vecmat.Sector3d(new vecmat.Vector3d(0.0, 0.0, 0.0), 0, Math.PI/2.0, -Math.PI/2, Math.PI/2);
            var p = new vecmat.Vector3d(1.0, 1.0, 0.0);
    ...
    describe('#containsPoint()', function () {
        it('should return true if point is contained', function () {
            var s = new vecmat.Sector3d(new vecmat.Vector3d(0.0, 0.0, 0.0), Math.PI/2.0, 0, -Math.PI/2, Math.PI/2);
            var p = new vecmat.Vector3d(-1.0, 1.0, 0.0);
