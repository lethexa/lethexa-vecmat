...
(function (exports) {
    ...
    /**
     * Checks if the point-order of the polygon is clockwise.
     * from: https://stackoverflow.com/questions/1165647/how-to-determine-if-a-list-of-polygon-points-are-in-clockwise-order/1165943#1165943
     * @returns {Boolean} True if clockwise order.
     */
    exports.Polygon2d.prototype.isClockwise = function() {
        var sum = 0.0;
        var lastCorner;
        var self = this;
        this._corners.forEach(function(corner) {
            if(!lastCorner) {
                lastCorner = self._corners[self._corners.length-1];
            }
            sum += (corner.x() - lastCorner.x()) * (corner.y() + lastCorner.y());
            lastCorner = corner;
        });
        return sum >= 0;
    };
    ...
    /**
     * Reverses the points of the polygon and returns them as new polygon.
     * @method reverse
     * @return A polygon with points in reversed order.
     */
    exports.Polygon2d.prototype.reverse = function () {
        var result = [];
        this._corners.forEach(function(corner) {
            result.push(corner);
        });
        return new exports.Polygon2d(result.reverse());
    };
